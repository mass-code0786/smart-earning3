...
export async function GET(r:NextRequest){try{await requireAdmin();return NextResponse.json(await getAdminX3Report("placements",r.nextUrl.searchParams))}catch(e){return apiError(e)}}
