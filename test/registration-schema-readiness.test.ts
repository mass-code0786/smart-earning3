...
function row(overrides: Record<string, unknown> = {}) {
  return {
    ...
    aligned_genesis_cap_migration_032: true,
    package_only_cap_migration_033: true,
    history_table: true,
...
describe("registration schema readiness", () => {
  ...
  it.each([
    ...
    ["aligned genesis cap migration", { aligned_genesis_cap_migration_032: false }],
    ["package-only cap migration", { package_only_cap_migration_033: false }],
